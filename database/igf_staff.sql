...
--
-- Table structure for table `igf_staff`
--

CREATE TABLE `igf_staff` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `igf_staff`
--
...
--
-- Indexes for table `igf_staff`
--
ALTER TABLE `igf_staff`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `igf_staff`
--
ALTER TABLE `igf_staff`
