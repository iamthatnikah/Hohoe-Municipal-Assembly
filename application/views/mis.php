          ...
          <tbody>
            <?php foreach($all_hhma_laptops as $all_laptops): ?>
              <tr>
                ...
                <td><a href="<?php echo site_url(); ?>mis/edit/<?php echo $all_laptops['id']; ?>" class="btn-warning"><i class="fa fa-edit"></i></a> 
                  <a href="<?php echo site_url(); ?>mis/delete/<?php echo $all_laptops['id']; ?>" onclick="return confirm('Do you want delete this record')" class="btn-danger"><i class="fa fa-trash"></i></a> 
                </td>
              </tr>
            <?php endforeach; ?>
            <!-- End of table -->
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Department</th>
              <th scope="col">Printer Manufacturer</th>
          ...
          <tbody>
            <?php foreach($all_hhma_printers as $all_printers): ?>
              <tr>
                ...
                <td><a href="<?php echo site_url(); ?>mis/edit/<?php echo $all_printers['id']; ?>" class="btn-warning"><i class="fa fa-edit"></i></a> 
                  <a href="<?php echo site_url(); ?>mis/delete/<?php echo $all_printers['id']; ?>" onclick="return confirm('Do you want delete this record')" class="btn-danger"><i class="fa fa-trash"></i></a> 
                </td>
              </tr>
            <?php endforeach; ?>
            <!-- End of table -->
