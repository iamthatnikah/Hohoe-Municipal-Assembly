                        ...
                        <form class="needs-validation" action="<?php echo site_url('staff/add_perm_staff') ?>" method="POST">
                          <div class="row">
                            <div class="col-md-3 mb-2">
                              ...
                              <input type="number" class="form-control" id="staff_id" placeholder="" name="" value="" required>
                      ...
                      <table class="table table-striped table-sm">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">date_first_appointment</th>
                            <th scope="col">date_last_promotion</th>
                        ...
                        <tbody>
                          <?php foreach($all_perm_staff as $perm_staff): ?>
                            <tr>
                              ...
                              <td><?php echo $perm_staff['grade'] ?></td>
                              <td><?php echo $perm_staff['date_first_appointment'] ?></td>
                              <td><?php echo $perm_staff['date_last_promotion'] ?></td>
                              <td><?php echo $perm_staff['department'] ?></td>
                              <td><?php echo $perm_staff['tel'] ?></td>
                              <td><?php echo $perm_staff['gender'] ?></td>
                              <td><a href="<?php echo site_url(); ?>mis/edit/<?php echo $perm_staff['id']; ?>" class="btn-warning"><i class="fa fa-edit"></i></a> 
                                <a href="<?php echo site_url(); ?>mis/delete/<?php echo $perm_staff['id']; ?>" onclick="return confirm('Do you want delete this record')" class="btn-danger"><i class="fa fa-trash"></i></a> 
                              </td>
                            </tr>
                          <?php endforeach; ?>
                          <!-- End of table -->
                            ...
                            <div class="table-responsive">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">date Last_promotion</th>
                                  <th scope="col">department</th>
                                  <th scope="col">tel</th>
                                  <th scope="col">gender</th> 
                                  <th scope="col">Actions</th>
                              ...
                              <tbody>
                                <?php foreach($all_temp_staff as $temp_staff): ?>
                                  <tr>
                                    ...
                                    <td><?php echo $temp_staff['official_email'] ?></td>
                                    <td><?php echo $temp_staff['grade'] ?></td>
                                    <td><?php echo $temp_staff['date_first_appointment'] ?></td>
                                    <td><?php echo $temp_staff['date_last_promotion'] ?></td>
