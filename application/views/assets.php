...
<!-- Form begining -->
  <div class="col-sm-12">
            <p>
              <a class="btn btn-primary" data-toggle="collapse" href="#multiCollapseExample" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Add Asset</a>          
            </p>
            <div class="row">
              <div class="col">
                      ...
                      <div class="form-row">
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <h4 class="mb-3">Tangible Assets</h4>
